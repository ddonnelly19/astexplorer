...
export function setParser(parser: unknown) {
  return {type: SET_PARSER, parser};
}

export function setParserSettings(settings: unknown) {
...
export function startSave(fork: boolean) {
  return {type: START_SAVE, fork};
}

export function endSave(fork: boolean) {
  return {type: END_SAVE, fork};
}

export function setSnippet(revision: unknown) {
  return {type: SET_SNIPPET, revision};
}

export function selectCategory(category: unknown) {
...
export function selectTransformer(transformer: unknown) {
...
export function setTransformState(state: Record<string, unknown>) {
  return {type: SET_TRANSFORM, ...state};
}

export function setCode(state: Record<string, unknown>) {
  return {type: SET_CODE, ...state};
}

export function setCursor(cursor: unknown) {
  return {type: SET_CURSOR, cursor};
}

export function dropText(text: string, categoryId: string) {
...
export function setKeyMap(keyMap: string) {
